...
const dailyRevenueData = Array.from({ length: 30 }, (_, i) => ({
  date: new Date(Date.now() - (29 - i) * 86400000).toLocaleDateString('es-ES', {
    day: '2-digit',
    month: 'short',
  }),
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground mt-1 text-xs">Después de comisión (15%)</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground mt-1 text-xs">15% de ingresos brutos</p>
          </CardContent>
        </Card>
              ...
              <CardContent>
                ...
                <div className="mt-4 rounded-lg bg-blue-50 p-3 dark:bg-blue-950/20">
                  <p className="text-sm text-blue-900 dark:text-blue-100">
                    <span className="font-medium">Promedio semanal:</span> {stats.occupancyRate}% de
                    ocupación
                  </p>
                </div>
              </CardContent>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mt-1 text-sm">
                  Basado en {stats.monthReservations} reservas
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="mt-1 text-sm text-green-600">Proyección: $118,140</p>
              </CardContent>
            </Card>
          </div>
        </TabsContent>
                    ...
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="flex items-center gap-6">
                        <div className="text-right">
                          <p className="text-muted-foreground text-xs">Monto Bruto</p>
