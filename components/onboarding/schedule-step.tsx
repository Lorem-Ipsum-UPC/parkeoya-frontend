        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button type="button" variant="link" onClick={selectAllDays} className="h-auto p-0 text-blue-600">
                Seleccionar todos
              </Button>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="is24Hours" className="text-sm font-medium cursor-pointer">
                Abierto 24 horas
              </label>
            </div>
