    ...
    <div className="bg-background min-h-screen p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
          {screenshots.map((screenshot, index) => (
            <div key={index} className="bg-card rounded-lg border p-4 shadow-sm">
              <>
                <div className="mb-4">
                  <h2 className="text-card-foreground mb-1 text-xl font-semibold">
                    {screenshot.title}
                  </h2>
        ...
        <div className="bg-muted/50 mt-12 rounded-lg border p-6">
          <h3 className="mb-3 text-lg font-semibold">Instrucciones para Figma:</h3>
